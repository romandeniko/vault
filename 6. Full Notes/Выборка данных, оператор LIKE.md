...
Найти строки, начинающиеся на text
```sql
    ... WHERE поле_таблицы LIKE 'text%'
```

Найти строки, заканчивающиеся на text
```sql
    ... WHERE поле_таблицы LIKE '%text'
```

Найти строки из 4 укв, заканчивающиеся на ext
```sql
    ... WHERE поле_таблицы LIKE '_ext'
```

Найти строки, начинающиеся на «begin» и заканчивающиеся на «end»
```sql
